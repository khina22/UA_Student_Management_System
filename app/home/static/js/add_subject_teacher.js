        ...
        validators: {
          callback: {
            ...
            callback: function(input) {
              ...
              // Check if the selected role is 'subject_teacher'
...
function save_user() {
    ...
    var selectedRole = $('#user-form [name="role"]').val();
    // var selectedGrade = $('#user-form [name="grade"]').val();
    // if (selectedRole === 'subject_teacher' && selectedGrade === '2') {
...
$(document).ready(function() {
    // Set the default value of the role field to "subject_teacher"
    $('#user-form [name="role"]').val('subject_teacher');
  });
